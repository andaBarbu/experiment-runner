...
class RunnerConfig:
    ...
    def validate_experiment(self) -> None:
        """Perform any experiment validation here. This is executed before 
        starting the experiment, and can be used to check for any possible 
        issues with the experiment setup before starting the runs."""
